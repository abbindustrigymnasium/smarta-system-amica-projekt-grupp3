<template>
  <q-page class='column flex-center'>
    ...
    <div class='flex flex-center bg-secondary q-pa-md q-ma-md rounded-borders' style="position: relative; width: 90%">
      <h7 class='q-ma-none q-mr-md'>{{foodData.foodData.food1.food}}</h7>
    ...
    <div class='flex flex-center bg-secondary q-pa-md q-ma-md rounded-borders' style="position: relative; width: 90%">
      <h7 class='q-ma-none q-mr-md'>{{foodData.foodData.food2.food}}</h7>
      <div class="flex flex-center">
    ...
    <div class='flex flex-center bg-secondary q-pa-md q-ma-md rounded-borders' style="position: relative; width: 90%">
      <h7 class='q-ma-none q-mr-md'>{{foodData.foodData.food3.food}}</h7>
      <div class="flex flex-center">
    ...
    <div class='column flex-center bg-secondary q-pa-md q-ma-md rounded-borders' style="position: relative; width: 90%">
      <h7 class='q-ma-none q-mr-md'>{{foodData.foodData.food4.food}}</h7>
      <div class="flex flex-center">
